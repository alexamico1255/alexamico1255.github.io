...
const children = [];
children.push(new Child("Amy", "Grey", "amy.jpg", 2));
children.push(new Child("Bobby", "White", "bobby.png", 3));
children.push(new Child("Carl", "Black", "carl.png", 1));
children.push(new Child("Dave", "Green", "dave.jpg", 4));
children.push(new Child("Erin", "Brown", "erin.jpg", 1));
