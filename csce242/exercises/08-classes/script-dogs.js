...
const dogs = [];
dogs.push(new Dog("Carlton", "Yorkie Poo", "Grey", 7, "small", "yorkie.jpg"));
dogs.push(new Dog("Baxter", "Golden", "Yellow", 1, "med", "golden-retriever.jpg"));
dogs.push(new Dog("Kiba", "Pit Bull", "White", 3, "lg", "pitt-bull.jpg"));
